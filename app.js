...
const currier_routes = require('./src/routes/CARRIEAR/currier')(router)
app.use("/api",currier_routes);
const contact_routes = require('./src/routes/contact/contact')(router)
app.use("/api",contact_routes);
const otpValidateMiddleware = require('./src/routes/Otp/OtpSendAndVerify');
otpValidateMiddleware(router);
