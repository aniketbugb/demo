 ...
 *
 */
export declare const getOAuthClients: (params?: Params, filter?: Filter) => Promise<ResourcePage<OAuthClient>>;
/**
 * getOAuthClient
 *
...
export declare const createOAuthClient: (data: OAuthClientRequest) => Promise<OAuthClientWithSecret>;
/**
 ...
 *
 */
export declare const resetOAuthClientSecret: (clientId: number | string) => Promise<OAuthClientWithSecret>;
/**
 * updateOAuthClient
 *
