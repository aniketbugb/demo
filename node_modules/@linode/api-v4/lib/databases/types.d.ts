...
export type DatabaseStatus = 'provisioning' | 'active' | 'suspending' | 'suspended' | 'resuming' | 'restoring' | 'failed' | 'degraded' | 'resizing';
...
type ReplicationCommitTypes = 'on' | 'local' | 'remote_write' | 'remote_apply' | 'off';
...
export type ComprehensiveReplicationType = MySQLReplicationType & PostgresReplicationType;
export type Database = BaseDatabase & Partial<MySQLDatabase> & Partial<PostgresDatabase> & Partial<MongoDatabase>;
