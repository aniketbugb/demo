 ...
 */
export declare const getLinodeTransfer: (linodeId: number) => Promise<RegionalNetworkUtilization>;
/**
 ...
 *
 */
export declare const getLinodeKernels: (params?: Params, filter?: Filter) => Promise<Page<Kernel>>;
/**
 * getLinodeKernel
 *
 ...
 */
export declare const getLinodeKernel: (kernelId: string) => Promise<Kernel>;
/**
 * getLinodeTypes
 *
 ...
 * This endpoint does not require authentication.
 */
export declare const getLinodeTypes: (params?: Params) => Promise<Page<Type>>;
/**
 * getType
 *
