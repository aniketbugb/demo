 ...
 * @param linodeId { number } The id of the Linode.
 */
export declare const getLinodeVolumes: (linodeId: number, params?: Params, filter?: Filter) => Promise<Page<Volume>>;
/**
 * getLinodes
 *
 ...
 * @param linodeId { number } The id of the Linode.
 */
export declare const getLinodes: (params?: Params, filter?: Filter) => Promise<Page<Linode>>;
/**
 * createLinode
 *
 ...
 */
export declare const getLinodeFirewalls: (linodeId: number, params?: Params, filter?: Filter) => Promise<Page<Firewall>>;
