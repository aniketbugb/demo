...
export declare const AFFINITY_TYPES: {
...
export type PlacementGroupPayload = Pick<PlacementGroup, 'id' | 'label' | 'affinity_type' | 'is_strict'>;
export interface CreatePlacementGroupPayload extends Omit<PlacementGroupPayload, 'id'> {
    region: Region['id'];
}
