    ...
    router.post('/post_vendorbank', (req, res) => {
        try {
            ...
            if (req.body.providerId !== undefined)
                        ...
                        if (req.body.clientRec_FirmAddres !== undefined)
                            obj.clientRec_FirmAddres = req.body.clientRec_FirmAddres;
                        if (req.body.clientRec_WebSite !== undefined)
                            obj.clientRec_WebSite = req.body.clientRec_WebSite;
                        if (req.body.clientRec_EstYear !== undefined)
                            obj.clientRec_EstYear = req.body.clientRec_EstYear;
